      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div
            ...
            className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-[#111317] border border-[#1F232B] rounded-xl shadow-2xl p-6 space-y-5"
          >
            <div>
              <h2
                id="launch-run-title"
            ...
            <section className="space-y-3">
              ...
              <SourceRow
                ...
                disabled={pending || !hasPappersKey}
                badge={
                  !hasPappersKey ? (
                    <Link
                      href="/settings"
